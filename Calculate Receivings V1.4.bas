...
FindSKULabel:
    ...
    ' ---- Step 4: Add the new columns (Invoice Qty, TCN, Gross Cost, Barcode, TCN Cost) ----
    ...
    For r = skuRow + 1 To lastRow
        ' Invoice Received Qty defaults to Ordered Quantity - only fill if
        ' the cell is still blank, so manual edits from earlier runs stay
    ...
    ' ---- Totals: Gross Cost SUM and TCN Cost SUM, both at the bottom ----
